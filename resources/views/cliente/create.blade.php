        ...
        <div class="col-md-12">
            <div class="m-portlet m-portlet--metal m-portlet--head-solid-bg">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="{{ URL::to('cliente') }}" class="m-portlet__nav-link btn btn-danger m-btn m-btn--air">
                                    Cancelar
                                </a>
                            </h3>
                        </div>
                ...
                {{ Form::open(array('url' => 'cliente')) }}
                    ...
                    {{ Form::text('cnpjcpf', Input::old('cnpjcpf'), array('class'	=>'form-control')) }}
                    </div>
                    
                    <div class="form-group">
                    {{ Form::label('ierg', 'Inscrição Estadual / RG') }} 
                    {{ Form::text('ierg', Input::old('ierg'), array('class'	=>'form-control')) }}
                    </div>
                    ...
                    {{ Form::text('contato', Input::old('contato'), array('class'	=>'form-control')) }}
                    </div>
