        ...
        <div class="col-md-12">
            <div class="m-portlet m-portlet--metal m-portlet--head-solid-bg">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <span class="m-portlet__head-icon m--font-transform-u" style="color:#302B3E;">
                                <i class="flaticon-user"></i><span style="margin:24px;">Clientes</span>
                            </span>
                            <h3 class="m-portlet__head-text m--font-primary ">
                            <a href="{{ URL::to('cliente/create') }}" class="m-portlet__nav-link btn btn-dark m-btn m-btn--air">
                                    Novo
                                </a>
                            </h3>
                        </div>
                ...
                <div class="m-portlet__body">
                            ...
                            <tr>
                                    <td><a href="{{ URL::to('cliente/' . $value->id ) }}" class="btn btn-square btn-sm btn-metal">{{ $value->id }}</a></td>
                                    <td>{{$value->nome}}</td>
                                    <td>{{$value->created_at}}</td>
                                    <td><a class="btn btn-small btn-success" href="{{ URL::to('cliente/' . $value->id . '/edit') }}">Editar</a></td>
                                    <td>
                                    {{ Form::open(array('url' => 'cliente/' . $value->id, 'class' => 'pull-right')) }}
