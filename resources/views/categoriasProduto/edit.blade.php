    ...
    <div class="row">
        <div class="col-md-12">
            <div class="m-portlet m-portlet--metal m-portlet--head-solid-bg">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <span class="m-portlet__head-icon m--font-transform-u" style="color:#302B3E;">
                                <i class="flaticon-gift"></i><span style="margin:24px;">Categoria de Produtos</span>
                            </span>
                ...
                <!-- ----------------------------------------------- -->
                {{ Form::model($categoria, array('route' => array('categoriasProduto.update', $categoria->id), 'method' => 'PUT')) }}
