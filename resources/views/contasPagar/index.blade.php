                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="{{ URL::to('contasPagar/create') }}" class="m-portlet__nav-link btn btn-dark m-btn m-btn--air">
                                    Nova Conta
                                </a>
                            </h3>
                        </div>
                ...
                <div class="m-portlet__body">
                        <table
                            ...
                            <tbody>
                                ...
                                @endif
                                <td><a href="{{ URL::to('contasPagar/'.$value->id.'/edit') }}"
                                    class="btn btn-square btn-md blue btn-success"> Editar </a></td>
                                <td>{{ Form::open(array('url' => 'contasPagar/' . $value->id,
                                    'class' => 'pull-right')) }} {{ Form::hidden('_method',
                                    'DELETE') }} {{ Form::submit('Apagar', array('class' => 'btn
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <small class="m--font-transform-u">Fornecedor</small>
                                                        <h5>{{ $value->fornecedor->nome}}</h5>
                                                    </div>
                                                    <div class="col-md-6">
